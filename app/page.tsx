...
const agentTools = [
  ...
  { name: "Cindy", icon: "C", color: "pink", note: "对标codex开源智能体，有APP、颜值高", links: ["https://github.com/makecindy/cindy"] },
  { name: "Minis", icon: "M", color: "teal", note: "手机端 AI 智能体", links: ["https://github.com/OpenMinis/AwesomeMinis"] },
